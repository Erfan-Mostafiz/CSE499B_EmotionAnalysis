...
# img size 48 x 48 = 2304 => 1-dimensional array, Save it in .csv along with labels
# Generate_data reads the csv file arrays and converts them back to images
class Generate_data():
    ...
    def split_test(self, val_filename= 'val'):
        ...
        train_data.to_csv(self.data_path+"/train.csv") # saving the train_data into a csv file with same name as original name
